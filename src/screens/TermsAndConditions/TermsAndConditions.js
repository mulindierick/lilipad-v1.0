    ...
    <SafeAreaView edges={['top', 'bottom']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <TextNormal
          ...
          <TextBigger>Lili Networks LLC End-User License Agreement</TextBigger>
          {'\n'}
          {'\n'}
          <TextBig>
            ...
            user-generated content you may submit. By using the App, you agree
            to be bound by this Agreement.
          </TextBig>
          {'\n'}
          {'\n'}
          <TextBig>1. User-Generated Content</TextBig>
          {'\n'}
          ...
          {'\n'}
          <TextNormal bold>3.1.</TextNormal> We reserve the right to terminate
          or suspend your account and access to the App if you violate this
          Agreement or engage in any conduct that we believe is harmful to the
          App or other users.{'\n'}
          ...
          {'\n'}
          {'\n'}
          This Agreement was last updated on December 4th, 2023{'\n'}
          {'\n'}
          <TextBig>Lili Networks LLC</TextBig>
          {'\n'}
          <TextBig>Broad Street</TextBig>
          {'\n'}
          <TextBig>New York 10005-1923</TextBig>
          {'\n'}
          <TextBig>United States of America</TextBig>
          {'\n'}
        </TextNormal>
      </ScrollView>
    </SafeAreaView>
